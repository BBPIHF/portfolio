...
const TechStack = () => {
  return (
    <div className="section py-[50px] bg-slate-200">
      <h1 className="text-center text-7xl font-bold text-primary  flex items-center justify-center pb-9 ">
        Tech Stack
      </h1>
      <div className="flex gap-10 flex-wrap items-center justify-center">
        {techStact.map((icon) => {
          return (
            <div
              key={icon.id}
              className="  w-[100px] h-[100px] p-6 flex flex-col items-center shaDow rounded-lg bg-primary"
            >
